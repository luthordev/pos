...
<div class="row">
    ...
    <div class="col-lg-8 col-md-12 col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('sale.submit')); ?>" method="post">
                <?php echo csrf_field(); ?>
                    <table class="table">
                        <thead>
                            <th>Produk</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\pos\resources\views/sale/index.blade.php ENDPATH**/ ?>